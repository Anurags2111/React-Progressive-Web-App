...
import classes from '../../sass/FaceAuthentication/FrontID.module.scss'
				...
				<Box className={classes.muiBox} display="flex" flexDirection='column'>
					...
					</Box>
					{
						...
						<Fragment>
					        ...
					        <Box className={classes.muiDescription}><Typography variant="body1">Frame front of your ID</Typography></Box>
