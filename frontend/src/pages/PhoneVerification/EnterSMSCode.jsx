...
import classes from '../../sass/PhoneVerification/EnterSMSCode.module.scss'
        ...
        <ThemeProvider theme={MaterialTheme}>
            <Grid container className={classes.muiGrid}>
                <Box className={classes.muiBox} display="flex" flexDirection='column'>
                    ...
                    <Box className={classes.muiDescription}><Typography variant="body1">A 6-digit verification code has been sent to +1(9**) *** *671</Typography></Box>
