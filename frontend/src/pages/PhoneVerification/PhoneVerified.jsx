...
import classes from '../../sass/PhoneVerification/PhoneVerified.module.scss'
        ...
        <ThemeProvider theme={MaterialTheme}>
            <Grid container className={classes.muiGrid}>
                <Box className={classes.muiBox} display="flex" flexDirection='column'>
                    ...
                    <Box className={classes.muiDescription}><Typography variant="body1">Your ID has a verified Mobile number credential now</Typography></Box>
