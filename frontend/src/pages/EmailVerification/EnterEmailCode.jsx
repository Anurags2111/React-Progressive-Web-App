...
import classes from '../../sass/EmailVerification/EnterEmailCode.module.scss'
            ...
            <Grid container className={classes.muiGrid}>
                <Box className={classes.muiBox} display="flex" flexDirection='column'>
                    <Box className={classes.muiHeader} display="flex">
                        {/* <Header1 redirectTo='/email-verification'/> */}
                    </Box>
                    <Box className={classes.muiTitle}><Typography variant="h1">Enter Verification Code</Typography></Box>
                    <Box className={classes.muiDescription}><Typography variant="body1">A 6-digit verification code has been sent to your email address</Typography></Box>
                    <Formik initialValues={{...INITIAL_FORM_STATE}} validationSchema={FORM_VALIDATION}
                        onSubmit={handleSubmit}>
                        <Form>
                            <Box className={classes.muiForm}>
                                <Typography variant="body1">
                                    <MaterialFormField name="verificationCode" label="Verification Code" />
                                </Typography>
                            </Box>
