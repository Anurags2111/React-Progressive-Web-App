...
import classes from '../../sass/EmailVerification/EmailCodeResent.module.scss'
        ...
        <ThemeProvider theme={MaterialTheme}>
            <Grid container className={classes.muiGrid}>
                <Box className={classes.muiBox} display="flex" flexDirection='column'>
                    ...
                    <Box className={classes.muiDescription}><Typography variant="body1">A 6-digit verification code has been <span className={classes.redText}>resent</span> to your email address</Typography></Box>
...
export default EmailCodeResent